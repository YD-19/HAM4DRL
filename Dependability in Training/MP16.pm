...
const double p_G_B1 = 0.0123087743977493;
const double p_G_B2 = 0.000703358537014243;
...
const double p_B1_G = 0.0105458533704547;
const double p_B1_B2 = 0.0238758120307095;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00803292507561858;
const double p_B2_B1 = 0.00733872167402192;
const double p_B2_B3 = 0.00852878464818763;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00054392167527876;
const double p_B3_B1 = 0.00027196083763938;
const double p_B3_B2 = 0.0233886320369867;
const double p_B3_C = 0.00027196083763938;
