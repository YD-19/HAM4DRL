...
const double p_G_B1 = 0.0116700835830311;
const double p_G_B2 = 0.0010250749093203;
...
const double p_B1_G = 0.00858665613896565;
const double p_B1_B2 = 0.0289182787208843;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00539844690835098;
const double p_B2_B1 = 0.00793156430380798;
const double p_B2_B3 = 0.00801461733316723;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000909445238404573;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.024944783681954;
