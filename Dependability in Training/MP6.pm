...
const double p_G_B1 = 0.00619953112789789;
const double p_G_B2 = 0;
const double p_G_B3 = 0.000104193800468872;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.00749599932620231;
const double p_B1_B2 = 0.0204666049018782;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00441352095124357;
const double p_B2_B1 = 0.00872319435069318;
const double p_B2_B3 = 0.0100732125240147;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00021568768423323;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.01401969947516;
const double p_B3_C = 0.0000718958947444101;
