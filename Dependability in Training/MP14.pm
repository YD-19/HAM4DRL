...
const double p_G_B1 = 0.0136354782157003;
const double p_G_B2 = 0.00071423933510811;
const double p_G_B3 = 0.0000649308486461918;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0112168592794018;
const double p_B1_B2 = 0.0247280761386812;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00749810174639332;
const double p_B2_B1 = 0.00792520880789674;
const double p_B2_B3 = 0.00773538344722855;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000243042897071333;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0198079961113136;
const double p_B3_C = 0.000243042897071333;
