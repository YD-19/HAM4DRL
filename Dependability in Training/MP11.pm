...
const double p_G_B1 = 0.0103702672605791;
const double p_G_B2 = 0.000347995545657016;
...
const double p_B1_G = 0.00833796553640912;
const double p_B1_B2 = 0.0263109134704465;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00684528584416279;
const double p_B2_B1 = 0.00871704369217605;
const double p_B2_B3 = 0.0120862078185999;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000587544065804935;
const double p_B3_B1 = 0.00142689273124056;
const double p_B3_B2 = 0.0171227127748867;
