...
const double p_G_B1 = 0.0114934570380115;
const double p_G_B2 = 0.00207713079000208;
...
const double p_B1_G = 0.009357050213081;
const double p_B1_B2 = 0.026866777839541;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00750406270911003;
const double p_B2_B1 = 0.0085077908421757;
const double p_B2_B3 = 0.00884236688653092;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00012291052114061;
const double p_B3_B1 = 0.000245821042281219;
const double p_B3_B2 = 0.0224926253687316;
const double p_B3_C = 0.000245821042281219;
