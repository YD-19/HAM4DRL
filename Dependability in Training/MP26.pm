...
const double p_G_B1 = 0.00999652898299202;
const double p_G_B2 = 0.00430406108989934;
...
const double p_B1_G = 0.00743130927935856;
const double p_B1_B2 = 0.0284540921091229;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00841261451726568;
const double p_B2_B1 = 0.00806025369978858;
const double p_B2_B3 = 0.00828047921071177;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0216504194060304;
const double p_B3_C = 0.00045341192473362;
