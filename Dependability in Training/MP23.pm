...
const double p_G_B1 = 0.0133979475484607;
const double p_G_B2 = 0.00192417331812999;
...
const double p_B1_G = 0.0101226396729609;
const double p_B1_B2 = 0.0277399260268639;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00801226569068698;
const double p_B2_B1 = 0.00811118255106583;
const double p_B2_B3 = 0.0108808546416737;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000197160883280757;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.021884858044164;
const double p_B3_C = 0.000197160883280757;
