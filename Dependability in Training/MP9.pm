...
const double p_G_B1 = 0.0118296111612116;
const double p_G_B2 = 0.0000530475836825633;
const double p_G_B3 = 0.000106095167365127;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0111751353239043;
const double p_B1_B2 = 0.0226121878819626;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00776615251860641;
const double p_B2_B1 = 0.00625606730665516;
const double p_B2_B3 = 0.0121885449250351;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000674195179504467;
const double p_B3_B1 = 0.00117984156413282;
const double p_B3_B2 = 0.0176976234619922;
