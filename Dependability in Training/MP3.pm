...
const double p_G_B1 = 0.0108368020668868;
const double p_G_B2 = 0.000574135208841682;
...
const double p_B1_G = 0.00648626735583257;
const double p_B1_B2 = 0.0250329380764163;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00656013456686291;
const double p_B2_B1 = 0.00700869077656294;
const double p_B2_B3 = 0.0105971404541632;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000658906215681968;
const double p_B3_B1 = 0.0000627529729220922;
const double p_B3_B2 = 0.00486335540146214;
