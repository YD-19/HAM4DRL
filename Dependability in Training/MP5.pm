...
const double p_G_B1 = 0.0118343195266272;
const double p_G_B2 = 0.0018363599265456;
...
const double p_B1_G = 0.0090863621207069;
const double p_B1_B2 = 0.0253417805935312;
const double p_B1_B3 = 0.000166722240746916;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00829891994917408;
const double p_B2_B1 = 0.00583703939008895;
const double p_B2_B3 = 0.00913278271918679;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000963623223319682;
const double p_B3_B1 = 0.000602264514574801;
const double p_B3_B2 = 0.0271019031558661;
