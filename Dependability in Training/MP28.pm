...
const double p_G_B1 = 0.011640571817563;
const double p_G_B2 = 0.00306330837304289;
const double p_G_B3 = 0.000068073519400953;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.00969029070872126;
const double p_B1_B2 = 0.0277408322249668;
const double p_B1_B3 = 0.0000950028500855026;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00776628888788549;
const double p_B2_B1 = 0.00808235878448548;
const double p_B2_B3 = 0.00848873436582833;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000553587245349867;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.020814880425155;
const double p_B3_C = 0.000110717449069973;
