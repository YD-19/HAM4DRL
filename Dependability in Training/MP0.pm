...
const double p_G_B1 = 0.0370381451009723;
const double p_G_B2 = 0.00266267763649963;
...
const double p_B1_G = 0.0242708175910533;
const double p_B1_B2 = 0.0184071331419072;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.0240277702446168;
const double p_B2_B1 = 0.00916635027390573;
const double p_B2_B3 = 0.00764766502142431;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.0292051756007394;
const double p_B3_B1 = 0.000369685767097967;
const double p_B3_B2 = 0.0195933456561922;
const double p_B3_C = 0.00480591497227357;
