...
const double p_G_B1 = 0.00833851897946484;
const double p_G_B2 = 0.000124455507156192;
...
const double p_B1_G = 0.00638947167652108;
const double p_B1_B2 = 0.0239366774747282;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00641124275529569;
const double p_B2_B1 = 0.0071293019438888;
const double p_B2_B3 = 0.0118479766117864;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000246974561620153;
const double p_B3_B1 = 0.000246974561620153;
const double p_B3_B2 = 0.0140158063719437;
