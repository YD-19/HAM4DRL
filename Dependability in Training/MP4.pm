...
const double p_G_B1 = 0.00611493294420124;
const double p_G_B2 = 0.000254788872675052;
...
const double p_B1_G = 0.0134387958838888;
const double p_B1_B2 = 0.0218092458915681;
const double p_B1_B3 = 0.000230379358009522;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00847504569877583;
const double p_B2_B1 = 0.00803190605439539;
const double p_B2_B3 = 0.0113554533872487;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00141793690180787;
const double p_B3_B1 = 0.00129977549332388;
const double p_B3_B2 = 0.0223325062034739;
const double p_B3_C = 0.000118161408483989;
