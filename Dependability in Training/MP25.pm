...
const double p_G_B1 = 0.00915590116643672;
const double p_G_B2 = 0.00213219616204691;
...
const double p_B1_G = 0.00879541108986616;
const double p_B1_B2 = 0.0278202676864245;
const double p_B1_B3 = 0.0000956022944550669;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00652285129604366;
const double p_B2_B1 = 0.00835607094133697;
const double p_B2_B3 = 0.00831343792633015;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000364785992217899;
const double p_B3_B1 = 0.0001215953307393;
const double p_B3_B2 = 0.023954280155642;
const double p_B3_C = 0.0001215953307393;
