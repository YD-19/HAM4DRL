...
const double p_G_B1 = 0.0130806348468112;
const double p_G_B2 = 0.003488169292483;
const double p_G_B3 = 0.0000581361548747166;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0125951431678144;
const double p_B1_B2 = 0.0290866255889815;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00973931582517686;
const double p_B2_B1 = 0.00881868398100591;
const double p_B2_B3 = 0.00906095551894563;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00128485159964024;
const double p_B3_B1 = 0.00141333675960427;
const double p_B3_B2 = 0.0219709623538481;
const double p_B3_C = 0.000128485159964024;
