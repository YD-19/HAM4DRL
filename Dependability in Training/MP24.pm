...
const double p_G_B1 = 0.0107627179450384;
const double p_G_B2 = 0.00229604649494152;
...
const double p_B1_G = 0.00952879581151832;
const double p_B1_B2 = 0.0284816753926702;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00667200427008273;
const double p_B2_B1 = 0.00773952495329597;
const double p_B2_B3 = 0.0100524864335913;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000100391526955125;
const double p_B3_B1 = 0.000100391526955125;
const double p_B3_B2 = 0.0226884850918582;
const double p_B3_C = 0.00020078305391025;
