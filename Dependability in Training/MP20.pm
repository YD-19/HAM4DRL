...
const double p_G_B1 = 0.0113850616388687;
const double p_G_B2 = 0.00210297316896302;
...
const double p_B1_G = 0.00843274372686137;
const double p_B1_B2 = 0.0295146030440148;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00757788380578165;
const double p_B2_B1 = 0.00827953971372439;
const double p_B2_B3 = 0.00879408737954907;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000114207400639561;
const double p_B3_B1 = 0.000228414801279123;
const double p_B3_B2 = 0.0214709913202376;
const double p_B3_C = 0.000114207400639561;
