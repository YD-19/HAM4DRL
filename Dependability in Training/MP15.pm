...
const double p_G_B1 = 0.0106904534931227;
const double p_G_B2 = 0.000204276181397249;
...
const double p_B1_G = 0.00685907714234812;
const double p_B1_B2 = 0.0245857830037413;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00741450620397458;
const double p_B2_B1 = 0.00746494502168869;
const double p_B2_B3 = 0.0101382023605367;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000676263162979422;
const double p_B3_B1 = 0.000386436093131098;
const double p_B3_B2 = 0.0188387595401411;
const double p_B3_C = 0.000193218046565549;
