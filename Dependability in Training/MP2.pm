...
const double p_G_B1 = 0.00824718318039261;
...
const double p_B1_G = 0.00914913083257091;
const double p_B1_B2 = 0.0223737835814689;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.007602890355011;
const double p_B2_B1 = 0.00829406220546654;
const double p_B2_B3 = 0.0115614200439837;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00223294033583423;
const double p_B3_B1 = 0.000446588067166845;
const double p_B3_B2 = 0.0141121829224723;
const double p_B3_C = 0.000357270453733476;
