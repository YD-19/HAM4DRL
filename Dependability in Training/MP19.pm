...
const double p_G_B1 = 0.0132699992460228;
const double p_G_B2 = 0.00233732941265174;
...
const double p_B1_G = 0.010775406718783;
const double p_B1_B2 = 0.0288400591590957;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00741265344664778;
const double p_B2_B1 = 0.00755429650613787;
const double p_B2_B3 = 0.00859301227573182;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000572868927589368;
const double p_B3_B1 = 0.000458295142071494;
const double p_B3_B2 = 0.0207378551787351;
const double p_B3_C = 0.000114573785517874;
