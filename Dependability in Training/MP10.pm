...
const double p_G_B1 = 0.0121689829219387;
const double p_G_B2 = 0;
const double p_G_B3 = 0.000138283896840213;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.00673059192328969;
const double p_B1_B2 = 0.0254471694633966;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00887092246364606;
const double p_B2_B1 = 0.00684969962382797;
const double p_B2_B3 = 0.0121273370389085;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000807161725858527;
const double p_B3_B1 = 0.00102729674200176;
const double p_B3_B2 = 0.0146756677428823;
const double p_B3_C = 0.000220135016143235;
