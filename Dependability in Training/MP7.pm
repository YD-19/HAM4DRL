...
const double p_G_B1 = 0.0107562143372467;
const double p_G_B2 = 0.000131173345576179;
...
const double p_B1_G = 0.00604672469079249;
const double p_B1_B2 = 0.0244617498854787;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00795305756267882;
const double p_B2_B1 = 0.00606178167887105;
const double p_B2_B3 = 0.0112991610494156;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000213644779945877;
const double p_B3_B1 = 0.0000712149266486255;
const double p_B3_B2 = 0.0165930779091298;
const double p_B3_C = 0.0000712149266486255;
