...
const double p_G_B1 = 0.0125531766510914;
const double p_G_B2 = 0.00146453727596067;
...
const double p_B1_G = 0.0103532830805558;
const double p_B1_B2 = 0.0283353010625738;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00737100737100737;
const double p_B2_B1 = 0.00997843854986712;
const double p_B2_B3 = 0.0101790101790102;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000569422036632818;
const double p_B3_B1 = 0.000189807345544273;
const double p_B3_B2 = 0.0188858308816551;
const double p_B3_C = 0.0000949036727721363;
