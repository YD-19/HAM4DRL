...
const double p_G_B1 = 0.0124889101207944;
const double p_G_B2 = 0.00470893332423395;
...
const double p_B1_G = 0.0104577561691588;
const double p_B1_B2 = 0.0282542885973764;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.0083634621248421;
const double p_B2_B1 = 0.00862482031624341;
const double p_B2_B3 = 0.00818922333057455;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000129132231404959;
const double p_B3_B1 = 0.000129132231404959;
const double p_B3_B2 = 0.0241477272727273;
const double p_B3_C = 0.000129132231404959;
