...
const double p_G_B1 = 0.0213994565217391;
const double p_G_B2 = 0.000339673913043478;
...
const double p_B1_G = 0.00754716981132075;
const double p_B1_B2 = 0.0249837345478204;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.0055101018533979;
const double p_B2_B1 = 0.0065119385540157;
const double p_B2_B3 = 0.0128569043245951;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000183004941133411;
const double p_B3_B1 = 0.000183004941133411;
const double p_B3_B2 = 0.00250106752882328;
const double p_B3_C = 0.00146403952906728;
