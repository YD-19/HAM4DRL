...
const double p_G_B1 = 0.0131261529728963;
const double p_G_B2 = 0.000922378317014332;
...
const double p_B1_G = 0.0103818723481087;
const double p_B1_B2 = 0.0260900965965514;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00632680928538917;
const double p_B2_B1 = 0.0079654073736914;
const double p_B2_B3 = 0.00892125625853436;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000516595634766886;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0251840371948857;
const double p_B3_C = 0.000129148908691722;
