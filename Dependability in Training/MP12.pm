...
const double p_G_B1 = 0.0123480987847903;
const double p_G_B2 = 0.00117600940807526;
...
const double p_B1_G = 0.00971891376846117;
const double p_B1_B2 = 0.0278227727489281;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00839580209895052;
const double p_B2_B1 = 0.00809595202398801;
const double p_B2_B3 = 0.0105947026486757;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000337097589752233;
const double p_B3_B1 = 0.000252823192314175;
