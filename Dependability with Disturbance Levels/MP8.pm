...
const double p_G_B1 = 0.0556938248415121;
const double p_G_B2 = 0.00417938483212022;
const double p_G_B3 = 0.000187837520544729;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0408830744071954;
const double p_B1_B2 = 0.131234668847097;
const double p_B1_B3 = 0.00241581803315246;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00569322770704151;
const double p_B2_B1 = 0.0731734227773242;
const double p_B2_B3 = 0.106141183220425;
const double p_B2_C = 0.00055166935145751;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000303720577069096;
const double p_B3_B1 = 0.00339154644393824;
const double p_B3_B2 = 0.238623133383953;
const double p_B3_C = 0.0058719311566692;
