...
const double p_G_B1 = 0.0307237527561726;
const double p_G_B2 = 0.00540330983014708;
const double p_G_B3 = 0.0000484601778488527;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0360263836341112;
const double p_B1_B2 = 0.0809254361000435;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00822764544555972;
const double p_B2_B1 = 0.0292770530829308;
const double p_B2_B3 = 0.0499645000069608;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000783626809256015;
const double p_B3_B1 = 0.000138287083986356;
const double p_B3_B2 = 0.165114778279709;
const double p_B3_C = 0.000276574167972711;
