...
const double p_G_B1 = 0.070658939686628;
const double p_G_B2 = 0.00489375402446877;
...
const double p_B1_G = 0.0536028422613915;
const double p_B1_B2 = 0.123797040460833;
const double p_B1_B3 = 0.0015522058569901;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.0058218250744652;
const double p_B2_B1 = 0.0649104483385556;
const double p_B2_B3 = 0.102684615682179;
const double p_B2_C = 0.000270782561603033;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000553474114441417;
const double p_B3_B1 = 0.00208617166212534;
const double p_B3_B2 = 0.221602520435967;
const double p_B3_C = 0.00417234332425068;
