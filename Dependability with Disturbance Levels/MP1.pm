...
const double p_G_B1 = 0.0203753957485301;
const double p_G_B2 = 0.00479421076436002;
const double p_G_B3 = 0.0000452284034373587;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0223291074727655;
const double p_B1_B2 = 0.0538956488500987;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00858053444471684;
const double p_B2_B1 = 0.0198145450874638;
const double p_B2_B3 = 0.0310341346639171;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000656352555086732;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.100796999531177;
const double p_B3_C = 0.000093764650726676;
