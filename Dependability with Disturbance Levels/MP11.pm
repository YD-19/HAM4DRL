...
const double p_G_B1 = 0.0614429702180969;
const double p_G_B2 = 0.00392916120949832;
const double p_G_B3 = 0.0000569443653550481;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0463169642857143;
const double p_B1_B2 = 0.142857142857143;
const double p_B1_B3 = 0.0031156994047619;
const double p_B1_C = 0.0000428100518001627;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00515737580583997;
const double p_B2_B1 = 0.0721526987738592;
const double p_B2_B3 = 0.117026924535457;
const double p_B2_C = 0.00080900012640627;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000328713088259464;
const double p_B3_B1 = 0.00416369911795321;
const double p_B3_B2 = 0.247192242371117;
const double p_B3_C = 0.00734125897112803;
