...
const double p_G_B1 = 0.0613603311332364;
const double p_G_B2 = 0.00369168810828952;
const double p_G_B3 = 0.0000559346683074169;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0424398836590062;
const double p_B1_B2 = 0.144156322969153;
const double p_B1_B3 = 0.00360493220269551;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00420128174697365;
const double p_B2_B1 = 0.0791834797056729;
const double p_B2_B3 = 0.1145264657014;
const double p_B2_C = 0.000569665321623546;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000413543551305247;
const double p_B3_B1 = 0.00480744378392349;
const double p_B3_B2 = 0.243318686999225;
const double p_B3_C = 0.0070302403721892;
