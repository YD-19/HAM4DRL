...
const double p_G_B1 = 0.0764858876794143;
const double p_G_B2 = 0.00462383200077064;
...
const double p_B1_G = 0.0473927722896086;
const double p_B1_B2 = 0.153119919969989;
const double p_B1_B3 = 0.00431411779417281;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00424561403508772;
const double p_B2_B1 = 0.0814035087719298;
const double p_B2_B3 = 0.122491228070175;
const double p_B2_C = 0.00210526315789474;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.0000751766651631334;
const double p_B3_B1 = 0.0058637798827244;
const double p_B3_B2 = 0.255074424898512;
const double p_B3_C = 0.00984814313637047;
