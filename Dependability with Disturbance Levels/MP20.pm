...
const double p_G_B1 = 0.0509345283637556;
const double p_G_B2 = 0.00426276095748169;
const double p_G_B3 = 0.000109301563012351;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0357892968159288;
const double p_B1_B2 = 0.16113584810552;
const double p_B1_B3 = 0.00546080819961354;
const double p_B1_C = 0.0000840124338402084;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.004891119428377;
const double p_B2_B1 = 0.0764715889758421;
const double p_B2_B3 = 0.117004083021436;
const double p_B2_C = 0.00263695134399456;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000444365446142908;
const double p_B3_B1 = 0.00604337006754355;
const double p_B3_B2 = 0.238002132954141;
const double p_B3_C = 0.00995378599360114;
