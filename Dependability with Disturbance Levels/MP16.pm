...
const double p_G_B1 = 0.0660801377067993;
const double p_G_B2 = 0.00344266998183035;
const double p_G_B3 = 0.0000956297217175098;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0373983739837398;
const double p_B1_B2 = 0.154819976771196;
const double p_B1_B3 = 0.00493612078977933;
const double p_B1_C = 0.0000580720092915215;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00401659313886877;
const double p_B2_B1 = 0.0829656943438467;
const double p_B2_B3 = 0.123395008889182;
const double p_B2_C = 0.00164614472904458;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000345638047836306;
const double p_B3_B1 = 0.00518457071754459;
const double p_B3_B2 = 0.252454030139638;
const double p_B3_C = 0.00953961012028204;
