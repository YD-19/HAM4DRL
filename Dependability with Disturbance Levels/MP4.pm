...
const double p_G_B1 = 0.0526438320286354;
const double p_G_B2 = 0.00442336233739778;
const double p_G_B3 = 0.0000582021360183919;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0565890948450819;
const double p_B1_B2 = 0.113279664456772;
const double p_B1_B3 = 0.000236774455418753;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00683528147252452;
const double p_B2_B1 = 0.0518104259035335;
const double p_B2_B3 = 0.0851639124009136;
const double p_B2_C = 0.0000167943033722961;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000577611767877084;
const double p_B3_B1 = 0.00061611921906889;
const double p_B3_B2 = 0.192768300666179;
const double p_B3_C = 0.00215641726674111;
