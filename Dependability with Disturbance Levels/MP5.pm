...
const double p_G_B1 = 0.0612616124212304;
const double p_G_B2 = 0.00461248619502371;
...
const double p_B1_G = 0.0571215896954594;
const double p_B1_B2 = 0.107802841515907;
const double p_B1_B3 = 0.000809087672740218;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00631565061095262;
const double p_B2_B1 = 0.0509869234701449;
const double p_B2_B3 = 0.0866546839701202;
const double p_B2_C = 0.0000659597975034217;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000400240144086452;
const double p_B3_B1 = 0.001240744446668;
const double p_B3_B2 = 0.207844706824094;
const double p_B3_C = 0.002481488893336;
