...
const double p_G_B1 = 0.0582187953961336;
const double p_G_B2 = 0.00376205907550192;
const double p_G_B3 = 0.000111744328975305;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0520438189101996;
const double p_B1_B2 = 0.125146240294962;
const double p_B1_B3 = 0.00095720920338923;
const double p_B1_C = 0.0000354521927181196;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00567782720674315;
const double p_B2_B1 = 0.064212128307188;
const double p_B2_B3 = 0.0991766174978537;
const double p_B2_C = 0.000253648638101928;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000425658706848849;
const double p_B3_B1 = 0.00178776656876516;
const double p_B3_B2 = 0.212105733622781;
const double p_B3_C = 0.00408632358574895;
