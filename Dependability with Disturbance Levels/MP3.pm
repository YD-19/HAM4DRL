...
const double p_G_B1 = 0.0314226947191039;
const double p_G_B2 = 0.00517929274155577;
const double p_G_B3 = 0.0000991252199340817;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0370555666733373;
const double p_B1_B2 = 0.0945900873857648;
const double p_B1_B3 = 0.000100060036021613;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00749807192436231;
const double p_B2_B1 = 0.0365620269073667;
const double p_B2_B3 = 0.0619983432831558;
const double p_B2_C = 0.0000142820417606901;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000691562932226833;
const double p_B3_B1 = 0.000366121552355382;
const double p_B3_B2 = 0.176145146855423;
const double p_B3_C = 0.00061020258725897;
