...
const double p_G_B1 = 0.0771217712177122;
const double p_G_B2 = 0.00562730627306273;
...
const double p_B1_G = 0.0482876503265979;
const double p_B1_B2 = 0.155851291129968;
const double p_B1_B3 = 0.00476161406507539;
const double p_B1_C = 0.0001831390025029;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00495540138751239;
const double p_B2_B1 = 0.0792533861909481;
const double p_B2_B3 = 0.121275189957053;
const double p_B2_C = 0.00125536835150314;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.00020708221163802;
const double p_B3_B1 = 0.00628149375301995;
const double p_B3_B2 = 0.245254365983295;
const double p_B3_C = 0.00924967211983157;
