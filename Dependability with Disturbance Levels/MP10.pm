...
const double p_G_B1 = 0.0510208893289951;
const double p_G_B2 = 0.00372518508039798;
const double p_G_B3 = 0.0000943084830480502;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.042895671903763;
const double p_B1_B2 = 0.138704567832527;
const double p_B1_B3 = 0.00278265336701057;
const double p_B1_C = 0.0000428100518001627;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00543932110050331;
const double p_B2_B1 = 0.0684767643938881;
const double p_B2_B3 = 0.0963730336064279;
const double p_B2_C = 0.000451395941950482;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000547975231519535;
const double p_B3_B1 = 0.00361663652802893;
const double p_B3_B2 = 0.228286481451038;
const double p_B3_C = 0.00641131020877856;
