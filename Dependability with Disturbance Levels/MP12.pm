...
const double p_G_B1 = 0.0716612377850163;
const double p_G_B2 = 0.00472632049562496;
const double p_G_B3 = 0.0000638691958868238;
const double p_G_C = 0;
formula p_G_G = 1-p_G_B1-p_G_B2-p_G_B3-p_G_C;//the sum of all outgoing tran. prob. is 1

const double p_B1_G = 0.0453229639230935;
const double p_B1_B2 = 0.145301360985094;
const double p_B1_B3 = 0.00349967595593001;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00513257054154878;
const double p_B2_B1 = 0.0790165494103803;
const double p_B2_B3 = 0.113968102951854;
const double p_B2_C = 0.000726070954658121;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000394699746264449;
const double p_B3_B1 = 0.00603326755004229;
const double p_B3_B2 = 0.248773611502678;
const double p_B3_C = 0.00744290950098675;
