...
const double p_G_B1 = 0.0751028806584362;
const double p_G_B2 = 0.00534979423868313;
...
const double p_B1_G = 0.0476804998981186;
const double p_B1_B2 = 0.147116756095904;
const double p_B1_B3 = 0.00468654486178089;
const double p_B1_C = 0.00006792094002581;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00425389007052502;
const double p_B2_B1 = 0.0761222433672898;
const double p_B2_B3 = 0.133587074144558;
const double p_B2_C = 0.00145527818202172;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0.000377301539390281;
const double p_B3_B1 = 0.00565952309085421;
const double p_B3_B2 = 0.260564443102928;
const double p_B3_C = 0.0113190461817084;
