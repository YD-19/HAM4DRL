...
const double p_G_B1 = 0.0330358838048225;
const double p_G_B2 = 0.00721473324473135;
...
const double p_B1_G = 0.0106861080595226;
const double p_B1_B2 = 0.0295615699590532;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00491757212439116;
const double p_B2_B1 = 0.0072124391157737;
const double p_B2_B3 = 0.0121300112401649;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0357073549388706;
const double p_B3_C = 0.000194061711624297;
