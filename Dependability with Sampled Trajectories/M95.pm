...
const double p_G_B1 = 0.0335016062413951;
const double p_G_B2 = 0.00718984243536791;
...
const double p_B1_G = 0.00997183527441577;
const double p_B1_B2 = 0.0296110223034178;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00508877077914735;
const double p_B2_B1 = 0.00776508726299521;
const double p_B2_B3 = 0.0116099362961288;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0330130192188469;
const double p_B3_C = 0.000154990700557967;
