...
const double p_G_B1 = 0.0333913043478261;
const double p_G_B2 = 0.00695652173913044;
...
const double p_B1_G = 0.00991218154943048;
const double p_B1_B2 = 0.0297365446482915;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00491482360781374;
const double p_B2_B1 = 0.00745553750676829;
const double p_B2_B3 = 0.0119121995918197;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0343237704918033;
const double p_B3_C = 0.000170765027322404;
