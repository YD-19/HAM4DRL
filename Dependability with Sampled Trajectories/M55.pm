...
const double p_G_B1 = 0.0318282753515914;
const double p_G_B2 = 0.00666173205033309;
...
const double p_B1_G = 0.0100702265800981;
const double p_B1_B2 = 0.0295481648337088;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00518806744487678;
const double p_B2_B1 = 0.00745784695201038;
const double p_B2_B3 = 0.0118028534370947;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0344827586206897;
const double p_B3_C = 0.000271517784414879;
