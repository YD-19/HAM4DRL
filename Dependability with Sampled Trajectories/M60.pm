...
const double p_G_B1 = 0.0319148936170213;
const double p_G_B2 = 0.00693802035152636;
...
const double p_B1_G = 0.0102476515798463;
const double p_B1_B2 = 0.0294010003659876;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00497689299680057;
const double p_B2_B1 = 0.00752458822135324;
const double p_B2_B3 = 0.0118497452304775;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0342549547345241;
const double p_B3_C = 0.000244678248103744;
