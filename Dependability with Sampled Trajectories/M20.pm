...
const double p_G_B1 = 0.0328542094455852;
const double p_G_B2 = 0.00684462696783025;
...
const double p_B1_G = 0.0102040816326531;
const double p_B1_B2 = 0.0287226001511716;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00519176017417518;
const double p_B2_B1 = 0.00586166471277843;
const double p_B2_B3 = 0.0105509964830012;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0383244206773619;
