...
const double p_G_B1 = 0.0315821439416945;
const double p_G_B2 = 0.0066808381415123;
...
const double p_B1_G = 0.0097799511002445;
const double p_B1_B2 = 0.0296658516707416;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00525268603263032;
const double p_B2_B1 = 0.00740151213688818;
const double p_B2_B3 = 0.011858336649423;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0335267569310123;
const double p_B3_C = 0.000322372662798195;
