...
const double p_G_B1 = 0.0320276996321143;
const double p_G_B2 = 0.00714131140445791;
...
const double p_B1_G = 0.010216823703031;
const double p_B1_B2 = 0.0294017482120559;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00494914885516941;
const double p_B2_B1 = 0.00739653015717627;
const double p_B2_B3 = 0.0120193615054114;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0348837209302326;
const double p_B3_C = 0.000223613595706619;
