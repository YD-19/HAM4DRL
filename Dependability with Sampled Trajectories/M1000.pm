...
const double p_G_B1 = 0.0339056332724306;
const double p_G_B2 = 0.00598334704807598;
...
const double p_B1_G = 0.0107559751468016;
const double p_B1_B2 = 0.0296944535282158;
const double p_B1_B3 = 0.00000710903843146176;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00487282540670185;
const double p_B2_B1 = 0.00817202122772048;
const double p_B2_B3 = 0.0117570026516563;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000144973759749485;
const double p_B3_B2 = 0.0326190959436342;
const double p_B3_C = 0.0000289947519498971;
