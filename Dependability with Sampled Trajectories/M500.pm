...
const double p_G_B1 = 0.0347663133163651;
const double p_G_B2 = 0.00609739042877521;
...
const double p_B1_G = 0.0111400873065367;
const double p_B1_B2 = 0.0293525710074267;
const double p_B1_B3 = 0.0000141731390668405;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.0048717115946736;
const double p_B2_B1 = 0.00804012846883909;
const double p_B2_B3 = 0.0117065425282379;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000289427223524645;
const double p_B3_B2 = 0.0324737344794651;
const double p_B3_C = 0.0000578854447049289;
