...
const double p_G_B1 = 0.0339700791295747;
const double p_G_B2 = 0.0059038081107814;
...
const double p_B1_G = 0.0108259508111595;
const double p_B1_B2 = 0.0296061430976696;
const double p_B1_B3 = 0.00000786769681043571;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00481480592812982;
const double p_B2_B1 = 0.00816197582999416;
const double p_B2_B3 = 0.0117090961441562;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000160797555877151;
const double p_B3_B2 = 0.0326097443318862;
const double p_B3_C = 0.0000321595111754301;
