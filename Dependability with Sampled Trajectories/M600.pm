...
const double p_G_B1 = 0.0344101935573388;
const double p_G_B2 = 0.00612815947089702;
...
const double p_B1_G = 0.0110481586402266;
const double p_B1_B2 = 0.0294145420207743;
const double p_B1_B3 = 0.0000118035882908404;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00490619970694915;
const double p_B2_B1 = 0.00804688813624463;
const double p_B2_B3 = 0.0117400494823569;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000242160067804819;
const double p_B3_B2 = 0.032812689187553;
const double p_B3_C = 0.0000484320135609638;
