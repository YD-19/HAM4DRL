...
const double p_G_B1 = 0.0319744204636291;
const double p_G_B2 = 0.00719424460431655;
...
const double p_B1_G = 0.0101191103615474;
const double p_B1_B2 = 0.0293032570886476;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00504515412945866;
const double p_B2_B1 = 0.00726502194642046;
const double p_B2_B3 = 0.0121083699107008;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0353430353430353;
const double p_B3_C = 0.000207900207900208;
