...
const double p_G_B1 = 0.0341755513363517;
const double p_G_B2 = 0.00715641886957792;
...
const double p_B1_G = 0.0105255463781887;
const double p_B1_B2 = 0.0293107229003728;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00496233622505444;
const double p_B2_B1 = 0.00753275498911142;
const double p_B2_B3 = 0.0114597836564207;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0324952212909866;
const double p_B3_C = 0.000147037200411704;
