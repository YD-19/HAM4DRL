...
const double p_G_B1 = 0.0338863892013498;
const double p_G_B2 = 0.00688976377952756;
...
const double p_B1_G = 0.0108038029386344;
const double p_B1_B2 = 0.0297104580812446;
const double p_B1_B3 = 0.0000360126764621147;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00500133964454765;
const double p_B2_B1 = 0.00791283379476646;
const double p_B2_B3 = 0.0116995623827811;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000717772035601493;
const double p_B3_B2 = 0.0326586276198679;
const double p_B3_C = 0.0000717772035601493;
