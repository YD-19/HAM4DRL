...
const double p_G_B1 = 0.0374251497005988;
const double p_G_B2 = 0.0134730538922156;
...
const double p_B1_G = 0.0123253903040263;
const double p_B1_B2 = 0.0271158586688578;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00611916264090177;
const double p_B2_B1 = 0.00418679549114332;
const double p_B2_B3 = 0.0103059581320451;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0391459074733096;
