...
const double p_G_B1 = 0.0347091932457786;
const double p_G_B2 = 0.00844277673545966;
...
const double p_B1_G = 0.0113812726332126;
const double p_B1_B2 = 0.0274185204345577;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00535236396074933;
const double p_B2_B1 = 0.00512934879571811;
const double p_B2_B3 = 0.0107047279214987;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0372881355932203;
