...
const double p_G_B1 = 0.0338461538461538;
const double p_G_B2 = 0.0123076923076923;
...
const double p_B1_G = 0.00947867298578199;
const double p_B1_B2 = 0.028436018957346;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00583279325988334;
const double p_B2_B1 = 0.00518470511989631;
const double p_B2_B3 = 0.0116655865197667;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0464285714285714;
