...
const double p_G_B1 = 0.0323115161557581;
const double p_G_B2 = 0.00787075393537697;
...
const double p_B1_G = 0.0101775660459073;
const double p_B1_B2 = 0.0294499783456042;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00485578323783626;
const double p_B2_B1 = 0.00679809653297077;
const double p_B2_B3 = 0.011653879770807;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.036908380373426;
