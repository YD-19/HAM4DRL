...
const double p_G_B1 = 0.0342548076923077;
const double p_G_B2 = 0.0102163461538462;
...
const double p_B1_G = 0.011479173499508;
const double p_B1_B2 = 0.0298458510987209;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00511609602518693;
const double p_B2_B1 = 0.00577200577200577;
const double p_B2_B3 = 0.0111504656959202;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0390879478827362;
