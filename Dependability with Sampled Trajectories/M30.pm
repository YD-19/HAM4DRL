...
const double p_G_B1 = 0.0316336166194523;
const double p_G_B2 = 0.00802644003777148;
...
const double p_B1_G = 0.0106882168925965;
const double p_B1_B2 = 0.0299791449426486;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00480339588918677;
const double p_B2_B1 = 0.00659070598748883;
const double p_B2_B3 = 0.011952636282395;
