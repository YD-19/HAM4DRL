...
const double p_G_B1 = 0.0341616760510137;
const double p_G_B2 = 0.00604842720996399;
...
const double p_B1_G = 0.0109386563396559;
const double p_B1_B2 = 0.0297340862318914;
const double p_B1_B3 = 0.0000101377723259091;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00484513069508595;
const double p_B2_B1 = 0.00820380409624425;
const double p_B2_B3 = 0.0118196500396046;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000205541396037162;
const double p_B3_B2 = 0.0328455150867385;
const double p_B3_C = 0.0000411082792074324;
