...
const double p_G_B1 = 0.0305793991416309;
const double p_G_B2 = 0.00616952789699571;
...
const double p_B1_G = 0.00989075878358429;
const double p_B1_B2 = 0.0299675228816061;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00498043400924938;
const double p_B2_B1 = 0.00754180007114906;
const double p_B2_B3 = 0.0120241906794735;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0349486049926579;
const double p_B3_C = 0.000293685756240822;
