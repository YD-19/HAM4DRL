...
const double p_G_B1 = 0.0340909090909091;
const double p_G_B2 = 0.00718582887700535;
...
const double p_B1_G = 0.00995512035903713;
const double p_B1_B2 = 0.0295389636882905;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00492921645175283;
const double p_B2_B1 = 0.0074924090066643;
const double p_B2_B3 = 0.0117118182893647;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0337078651685393;
const double p_B3_C = 0.000162839928350432;
