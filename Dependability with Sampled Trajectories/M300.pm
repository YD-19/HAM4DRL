...
const double p_G_B1 = 0.0340616665886867;
const double p_G_B2 = 0.00608244046226547;
...
const double p_B1_G = 0.0106576124118743;
const double p_B1_B2 = 0.0293791704982198;
const double p_B1_B3 = 0.0000235787885218457;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00488762083619247;
const double p_B2_B1 = 0.00806577822721418;
const double p_B2_B3 = 0.0116412052921136;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000483091787439614;
const double p_B3_B2 = 0.0322222222222222;
const double p_B3_C = 0.0000966183574879227;
