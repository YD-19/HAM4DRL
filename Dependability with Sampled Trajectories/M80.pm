...
const double p_G_B1 = 0.0333516584203775;
const double p_G_B2 = 0.00733003481766538;
...
const double p_B1_G = 0.0101169482086505;
const double p_B1_B2 = 0.0299795804715055;
const double p_B1_B3 = 0;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00497293491176341;
const double p_B2_B1 = 0.00748140650442283;
const double p_B2_B3 = 0.0119262421335211;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0;
const double p_B3_B2 = 0.0349624748306791;
const double p_B3_C = 0.000183049606443346;
