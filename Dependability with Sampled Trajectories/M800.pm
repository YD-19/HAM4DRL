...
const double p_G_B1 = 0.0342852152650424;
const double p_G_B2 = 0.00579862020784211;
...
const double p_B1_G = 0.011026346136787;
const double p_B1_B2 = 0.0295662201720926;
const double p_B1_B3 = 0.00000887075312694048;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00473816247573493;
const double p_B2_B1 = 0.00816567354420859;
const double p_B2_B3 = 0.0117778468384476;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000180154212005477;
const double p_B3_B2 = 0.032697989478994;
const double p_B3_C = 0.0000360308424010953;
