...
const double p_G_B1 = 0.0344343923136265;
const double p_G_B2 = 0.00648713093484817;
...
const double p_B1_G = 0.0108926297920498;
const double p_B1_B2 = 0.0292827839864196;
const double p_B1_B3 = 0.0000176828405715094;
const double p_B1_C = 0;
formula p_B1_B1 = 1-p_B1_G-p_B1_B2-p_B1_B3-p_B1_C;

const double p_B2_G = 0.00496758896131411;
const double p_B2_B1 = 0.00802387327689575;
const double p_B2_B3 = 0.0116210928695715;
const double p_B2_C = 0;
formula p_B2_B2 = 1-p_B2_G-p_B2_B1-p_B2_B3-p_B2_C;

const double p_B3_G = 0;
const double p_B3_B1 = 0.0000363279689032586;
const double p_B3_B2 = 0.0322955643549969;
const double p_B3_C = 0.0000726559378065172;
